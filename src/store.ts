export function Store(bounds, max_objects = 4, max_levels = 10, level = 0) {
 ...
 */
Store.prototype.split = function() {
 ...
 */
Store.prototype.getIndex = function(pRect) {
 ...
 */
Store.prototype.insert = function(pRect) {
 ...
 */
Store.prototype.retrieve = function(pRect) {
